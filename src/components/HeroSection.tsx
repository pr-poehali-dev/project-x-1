...
const images = [
  ...
  'https://images.unsplash.com/photo-1593720213428-28a5b9e94613?w=1920&q=80',
          ...
          <div className="flex max-w-2xl flex-col gap-12">
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-base font-light text-white/70 md:text-lg max-w-xl">
                  Создаю современные веб-приложения с фокусом на UX и производительность. Специализируюсь на React, TypeScript и современном frontend-стеке.
                </p>
